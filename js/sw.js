...
const cachefiles=[
    ...
    'https://neozenweb.github.io/mws-restaurant-stage-1/img/1.jpg',
    '/../../img/2.jpg',
    '/../../img/3.jpg',
    '/../../img/4.jpg',
    '/../../img/5.jpg',
...
self.addEventListener('install',function(e){
     ...
     e.waitUntil(
        caches.open('v1').then(function(cache){
              ...
              cache.add(cachefiles).then(function(){console.log("successfully cached");return cache.add(cachefiles);})
